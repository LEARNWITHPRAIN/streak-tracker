...
export const MealCard: React.FC<MealCardProps> = ({ meal, onDelete }) => {
  ...
  return (
    <div className="group relative p-4 rounded-xl bg-card/40 hover:bg-card/70 border border-border/70 hover:border-primary/30 transition-all duration-200">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <div className="p-2 rounded-lg bg-muted/60 border border-border/60 text-muted-foreground group-hover:text-primary group-hover:border-primary/30 transition-colors">
      ...
      <div className="grid grid-cols-4 gap-2 mt-3 pt-3 border-t border-border/40 text-center">
        ...
        <div className="p-1.5 rounded-lg bg-primary/10 border border-primary/20">
          <div className="text-[10px] text-primary font-medium">Protein</div>
        ...
        <div className="p-1.5 rounded-lg bg-rose-500/10 border border-rose-500/15">
          <div className="text-[10px] text-rose-400 font-medium">Fat</div>
