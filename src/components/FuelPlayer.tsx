        ...
        <div className="space-y-4 pt-1">
          ...
          <div className="space-y-3 p-4 rounded-2xl bg-muted/40 border border-pink-500/20">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-foreground text-sm">Instagram Reels</p>
                <p className="text-[11px] text-muted-foreground leading-relaxed mt-1">
                  Due to Instagram's strict policy against embedding, Reels cannot be played directly on third-party websites. To add a Reel, please download it as an MP4 and upload it via the <strong className="text-foreground">Upload Video</strong> option below.
                </p>
              </div>
            </div>
            ...
            <div className="pt-2 border-t border-border/40">
              <Button
                type="button"
                variant="outline"
                onClick={() => window.open('https://sssinstagram.com/reels-downloader', '_blank')}
                className="w-full text-xs font-bold border-pink-500/30 text-pink-500 hover:bg-pink-500/10 hover:text-pink-400"
              >
